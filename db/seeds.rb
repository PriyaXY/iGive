...
puts 'Creating users...'
user = User.new(first_name: "Emma", last_name: "Jones", email: "emma@test.com", password: "123456789")
user.save!
...
crisis = Charity.new(user_id: 1, name: "Crisis", phone_number: "0300 636 1967", description:"We are the national charity for homeless people. We help people directly out of homelessness and campaign for the changes needed to solve it altogether. Find out more about ending homelessness" , website: "www.crisis.org.uk")
crisis.save!

emmaus  = Charity.new(user_id: 1, name: "Emmaus", phone_number: "0300 303 7555", description:"We supports more than 800 formerly homeless people. We provide them with support, a home for as long as they need it and meaningful work and training in our social enterprises." , website: "emmaus.org.uk")
emmaus.save!
...
address: "37 Crescent Rd, Windermere LA23 1BL" , number_of_volunteers: 3, start_date: 2020-11-01)
windermere.save!
...
address: "37 Crescent Rd, Windermere LA23 1BL" , number_of_volunteers: 6, start_date: 2020-9-20)
trussell.save!
...
address: "Home Based" , number_of_volunteers: 1, start_date: 2020-10-15)
fareshare.save!
